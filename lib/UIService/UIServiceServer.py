...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'UIService'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from UIService.UIServiceImpl import UIService  # noqa @IgnorePep8
impl_UIService = UIService(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'UIService'
        ...
        self.rpc_service.add(impl_UIService.am_admin_user,
                             ...
                             types=[])
        self.method_authentication['UIService.am_admin_user'] = 'required'  # noqa
        self.rpc_service.add(impl_UIService.add_alert,
                             name='UIService.add_alert',
                             types=[dict])
